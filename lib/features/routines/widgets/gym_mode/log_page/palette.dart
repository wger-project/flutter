...
SlotEntryType resolveType(SlotPageEntry sp) {
  return sp.typeOverride ?? sp.setConfigData?.type ?? SlotEntryType.normal;
}

/// Renders a weight / reps / RiR value for an input field or set row, dropping
/// a trailing `.0` so whole numbers read as "80" rather than "80.0".
String formatSetValue(num? value) {
  if (value == null) {
    return '';
  }
