...
List<_HistorySession> _historySessionsFor(GymModeState gymState, List<Log> pastLogs) {
  final sessionStart = gymState.workoutStart;
  final logs = pastLogs.where((l) => l.date.isBefore(sessionStart)).toList();
