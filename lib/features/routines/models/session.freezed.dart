...
/// Client-generated UUID, is `null` only before the first persist
 String? get id; int? get routineId; int? get dayId; DateTime get date; WorkoutImpression get impression; String? get notes; DateTime? get timeStart; DateTime? get timeEnd; List<Log> get logs;
...
@useResult
$Res call({
 String? id, int? dayId, int? routineId, DateTime date, WorkoutImpression impression, String? notes, DateTime? timeStart, DateTime? timeEnd, List<Log> logs
});
...
as DateTime?,timeEnd: freezed == timeEnd ? _self.timeEnd : timeEnd // ignore: cast_nullable_to_non_nullable
