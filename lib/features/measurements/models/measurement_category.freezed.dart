...
@override
int get hashCode => Object.hash(runtimeType,id,name,unit,const DeepCollectionEquality().hash(entries),metricType,parentId,order,isOfficial,const DeepCollectionEquality().hash(children));

@override
String toString() {
  return 'MeasurementCategory(id: $id, name: $name, unit: $unit, entries: $entries, metricType: $metricType, parentId: $parentId, order: $order, isOfficial: $isOfficial, children: $children)';
}
...
@useResult
$Res call({
 String? id, String name, String unit, List<MeasurementEntry> entries, MetricType metricType, String? parentId, int order, bool isOfficial, List<MeasurementCategory> children
});
...
/// Create a copy of MeasurementCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? unit = null,Object? entries = null,Object? metricType = null,Object? parentId = freezed,Object? order = null,Object? isOfficial = null,Object? children = null,}) {
