...
import 'package:wger/models/exercises/equipment.dart' as _i12;
import 'package:wger/models/exercises/exercise.dart' as _i3;
import 'package:wger/models/exercises/language.dart' as _i9;
import 'package:wger/models/exercises/muscle.dart' as _i13;
...
class _FakeTranslation_2 extends _i1.SmartFake implements _i4.Translation {
  _FakeTranslation_2(Object parent, Invocation parentInvocation) : super(parent, parentInvocation);
}

class _FakeVariation_3 extends _i1.SmartFake implements _i5.Variation {
  _FakeVariation_3(Object parent, Invocation parentInvocation) : super(parent, parentInvocation);
}

class _FakeAlias_4 extends _i1.SmartFake implements _i6.Alias {
  _FakeAlias_4(Object parent, Invocation parentInvocation) : super(parent, parentInvocation);
}
...
class MockAddExerciseProvider extends _i1.Mock implements _i8.AddExerciseProvider {
  ...
  @override
  set category(_i10.ExerciseCategory? _category) => super.noSuchMethod(
        Invocation.setter(#category, _category),
        returnValueForMissingStub: null,
      );

  @override
  List<_i11.File> get exerciseImages => (super.noSuchMethod(
        Invocation.getter(#exerciseImages),
        returnValue: <_i11.File>[],
      ) as List<_i11.File>);
  ...
  @override
  set equipment(List<_i12.Equipment>? equipment) => super.noSuchMethod(
        Invocation.setter(#equipment, equipment),
        returnValueForMissingStub: null,
      );

  @override
  List<_i12.Equipment> get equipment => (super.noSuchMethod(
        Invocation.getter(#equipment),
        returnValue: <_i12.Equipment>[],
      ) as List<_i12.Equipment>);
  ...
  @override
  List<_i13.Muscle> get primaryMuscles => (super.noSuchMethod(
        Invocation.getter(#primaryMuscles),
        returnValue: <_i13.Muscle>[],
      ) as List<_i13.Muscle>);

  @override
  set primaryMuscles(List<_i13.Muscle>? muscles) => super.noSuchMethod(
        Invocation.setter(#primaryMuscles, muscles),
        returnValueForMissingStub: null,
      );

  @override
  List<_i13.Muscle> get secondaryMuscles => (super.noSuchMethod(
        Invocation.getter(#secondaryMuscles),
        returnValue: <_i13.Muscle>[],
      ) as List<_i13.Muscle>);

  @override
  set secondaryMuscles(List<_i13.Muscle>? muscles) => super.noSuchMethod(
  ...
  @override
  void addExerciseImages(List<_i11.File>? exercises) => super.noSuchMethod(
  ...
  _i14.Future<_i5.Variation> addVariation() => (super.noSuchMethod(
        ...
        returnValue: _i14.Future<_i5.Variation>.value(
  ...
  @override
  _i14.Future<_i4.Translation> addExerciseTranslation(
    _i4.Translation? exercise,
  ) =>
      (super.noSuchMethod(
        Invocation.method(#addExerciseTranslation, [exercise]),
        returnValue: _i14.Future<_i4.Translation>.value(
          _FakeTranslation_2(
            this,
            Invocation.method(#addExerciseTranslation, [exercise]),
          ),
  ...
  @override
  _i14.Future<_i6.Alias> addExerciseAlias(String? name, int? exerciseId) => (super.noSuchMethod(
        Invocation.method(#addExerciseAlias, [name, exerciseId]),
        returnValue: _i14.Future<_i6.Alias>.value(
          _FakeAlias_4(
            this,
            Invocation.method(#addExerciseAlias, [name, exerciseId]),
          ),
