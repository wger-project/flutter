...
void main() {
  ...
  setUp(() {
    // Use in-memory SharedPreferences for tests — no real disk access
  ...
  test('selectCategory updates state but does NOT save to SharedPreferences', () async {
    ...
    // We use a mock category object
    // In a real test, import ExerciseCategory from models
    // notifier.selectCategory(ExerciseCategory(id: 1, name: 'Arms'));
    // For now, test null selection:
  ...
  test('settings persist across provider container restart', () async {
    // Simulate app restart: create container, set values, destroy, create new container
