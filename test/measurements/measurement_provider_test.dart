...
void main() {
  ...
  final tMeasurementCategory = MeasurementCategory(id: 1, name: 'Strength', unit: 'kN');
  ...
  group('addCategory()', () {
    final tMeasurementCategoryWithoutId = MeasurementCategory(
      id: null,
      name: 'Strength',
      unit: 'kN',
    );
  ...
  group('editCategory()', () {
    ...
    test('should keep categories list as is on WgerHttpException', () {
      ...
      expect(
        () =>
            measurementProvider.editCategory(tCategoryId, tCategoryEditedName, tCategoryEditedUnit),
        throwsA(isA<WgerHttpException>()),
      );
      expect(measurementProvider.categories, tMeasurementCategories);
    });
