...
void main() {
  ...
  group('REST routine repository (mocked db)', () {
    final mockBaseProvider = MockWgerBaseProvider();
    // The repository takes a Drift database in its constructor, but none of the
    // REST methods exercised here touch it, so a plain mock is enough.
